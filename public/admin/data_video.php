...
<h4 class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">
        		...
        		<br>
            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onclick="window.location.href='addvideo.php'">
  Tambah Video
</button>
        				...
        				<table class="w-full whitespace-no-wrap">
        					<thead>
        						<tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
        							...
        							<th class="px-4 py-3">Admin Uploader</th>
              ...
              $sql = "SELECT * FROM videos WHERE judul_video LIKE '%$cari%' OR tanggal_upload_video LIKE '%$cari%' OR kategori_video LIKE '%$cari%'";
              ...
              $sqlPerHalaman = "SELECT * FROM videos WHERE judul_video LIKE '%$cari%' LIMIT $dataAwal,$jumlahData";
              ...
              if ($ambildata_perhalaman->num_rows > 0) {
                  ...
                  while ($video = $ambildata_perhalaman->fetch_assoc()) {
                      echo "<tr>";
                      ...
                      echo "<td class='px-4 py-3 text-sm'>" .
                          ...
                          "</td>";
                      echo "<td class='px-4 py-3 text-sm'>" .
                      $video["tanggal_upload_video"]  .
                          "</td>";
                      echo "<td class='px-4 py-3 text-sm'>" .
                      $video["kategori_video"]   .
                          "</td>";
                      echo "<td class='px-4 py-3 text-sm'>" .
                          $video["id_admin"] .
                          "</td>";
                      ...
                      <form action="" method="post" onsubmit="return confirm(\'Apakah Anda yakin ingin menghapus item ini?\')">
                        <input type="hidden" name="id_konsultan" value="'.$video['id_video'].'">
                        <button
                          type="submit"
                          name="hapus"
